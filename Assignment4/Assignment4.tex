...
\begin{lstlisting}
https://github.com/Geetha495/Assignment2/blob/main/Assignment4.tex
\end{lstlisting}
Download all python codes from
\begin{lstlisting}
https://github.com/Geetha495/Assignment2/blob/main/Assignment4.py
\end{lstlisting}
...
\begin{align*}
  ...
  \Pr(ABC) &= \frac{3}{100} 
\end{align*}
Required probability : $\Pr(A+B+C)^{\prime}$ \begin{align*}
    \Pr(A+B+C)^{\prime} &= 1-\Pr(A+B+C) \\
    &= 1-\Pr(A)-\Pr(B)-\Pr(C)+\Pr(AB)+\Pr(BC)+\Pr(AC)-\Pr(ABC) \\
    &= 0.26
\end{align*}
